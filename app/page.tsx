      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
           <div className="p-3">
            ...
            <p className="">
            We know that it takes time to share  lessons and capture the allocations, so we would like to make it worth your while by offering you a smart platform to do it paperlessly.
            </p>
           </div>
           <Link
            href="/login"
